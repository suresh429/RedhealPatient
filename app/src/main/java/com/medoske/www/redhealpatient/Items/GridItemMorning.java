...
public class GridItemMorning {
    ...
    public GridItemMorning(String slotId, String bookingTime, String bookingSession, String bookingDate, String appointmentType, String status) {
        this.slotId = slotId;
