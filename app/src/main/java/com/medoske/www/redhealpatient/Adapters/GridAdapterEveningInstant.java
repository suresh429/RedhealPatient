...
public class GridAdapterEveningInstant extends ArrayAdapter<GridItemEveningInstant> {

    private Context activity;
    public List<GridItemEveningInstant> parkingList;
    ArrayList<GridItemEveningInstant> arraylist;
    GridItemEveningInstant book;


    // constructor
    public GridAdapterEveningInstant(Context activity, int resource, List<GridItemEveningInstant> books) {
        super(activity, resource, books);
        this.activity = activity;
        this.parkingList = books;
        arraylist = new ArrayList<GridItemEveningInstant>();
    ...
    @Override
    public GridItemEveningInstant getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final GridItemEveningInstant productItem=parkingList.get(position);
