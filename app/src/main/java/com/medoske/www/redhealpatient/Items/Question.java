...
public class Question {
    ...
    public Question(String authorName, String authorJobTitle, String authorAvatar, String date, String text, String tipTitle, List<Tag> tags) {
    ...
    public boolean equals(Object o) {
        ...
        if (getText() != null ? !getText().equals(question.getText()) : question.getText() != null)
            return false;
        if (getTipTitle() != null ? !getTipTitle().equals(question.getTipTitle()) : question.getTipTitle() != null)
            return false;
