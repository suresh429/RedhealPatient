...
public class PackageAdapter extends ArrayAdapter<PackageItem> {
    ...
    public List<PackageItem> parkingList;
    ArrayList<PackageItem> arraylist;
    PackageItem book;


    // constructor
    public PackageAdapter(Context activity, int resource, List<PackageItem> books) {
        super(activity, resource, books);
        this.activity = activity;
        this.parkingList = books;
        arraylist = new ArrayList<PackageItem>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final PackageItem productItem=parkingList.get(position);
