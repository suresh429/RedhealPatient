...
public class BestPackageAdapter extends ArrayAdapter<BestPackageItem> {

    private Context activity;
    public List<BestPackageItem> parkingList;
    ArrayList<BestPackageItem> arraylist;
    BestPackageItem book;


    // constructor
    public BestPackageAdapter(Context activity, int resource, List<BestPackageItem> books) {
        super(activity, resource, books);
        this.activity = activity;
        this.parkingList = books;
        arraylist = new ArrayList<BestPackageItem>();
    ...
    @Override
    public BestPackageItem getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BestPackageItem productItem=parkingList.get(position);
