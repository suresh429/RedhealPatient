...
public class GridItemAfterNoon {
    ...
    public GridItemAfterNoon(String slotId, String bookingTime, String bookingSession, String bookingDate, String appointmentType, String status) {
        this.slotId = slotId;
