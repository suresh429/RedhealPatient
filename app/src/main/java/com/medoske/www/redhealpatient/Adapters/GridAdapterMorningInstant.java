...
public class GridAdapterMorningInstant extends ArrayAdapter<GridItemMorningInstant> {

    private Context activity;
    public List<GridItemMorningInstant> parkingList;
    ArrayList<GridItemMorningInstant> arraylist;
    GridItemMorningInstant book;


    // constructor
    public GridAdapterMorningInstant(Context activity, int resource, List<GridItemMorningInstant> books) {
        super(activity, resource, books);
        this.activity = activity;
        this.parkingList = books;
        arraylist = new ArrayList<GridItemMorningInstant>();
    ...
    @Override
    public GridItemMorningInstant getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final GridItemMorningInstant productItem=parkingList.get(position);
